...
<body style="text-align: center;font-size: x-large;" bgcolor="#1363DF">
	...
	<div style="margin-top: 200px;">
		...
		<a href="/search"><button type="button" style="border: 2px solid #06283D; background: #06283D; padding: 6px; color: #DDF9DF;">Add Products Now</button></a>
	</div>
	@else
		<table border="1px solid black" style="margin: auto; background: #47B5FF; border-radius: 7px;">
			<tr>
				<th>ID</th><th>Photo</th><th>Name</th><th>Price</th><th>Quantity</th><th>Total</th><th>Size</th><th></th>
			</tr>
